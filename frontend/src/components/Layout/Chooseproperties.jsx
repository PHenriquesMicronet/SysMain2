         ...
         <p className="text-center text-3xl mt-24 antialiased">Selecione a propriedade que deseja abrir</p>
            <div className="flex justify-center items-center mt-20">
                <div className="grid grid-cols-2 gap-4">
                    <a href="/homepage" className="card-link">
                        <div
                        ...
                        >
                            <Card className="w-80 h-80 flex flex-col justify-center items-center">
                                <CardHeader className="flex flex-col items-center justify-center">
                                    <p className="text-large text-center mb-10">Propriedade 1</p>
                    ...
                    >
                        <Card className="w-80 h-80 flex flex-col justify-center items-center">
                            <CardHeader className="flex flex-col items-center justify-center">
                                <p className="text-large text-center mb-10">Propriedade 2</p>
                                <Image className="w-52 h-52"
                                    src="/images/Logo-Login.png"
                                />
                            </CardHeader>
                    ...
                    >
                        <Card className="w-80 h-80 flex flex-col justify-center items-center">
                            <CardHeader className="flex flex-col items-center justify-center">
                                <p className="text-large text-center mb-10">Propriedade 3</p>
                                <Image className="w-52 h-52"
                                    src="/images/Logo-Login.png"
                                />
                            </CardHeader>
                    ...
                    >
                        <Card className="w-80 h-80 flex flex-col justify-center items-center">
                            <CardHeader className="flex flex-col items-center justify-center">
                                <p className="text-large text-center mb-10">Propriedade 4</p>
                                <Image className="w-52 h-52"
                                    src="/images/Logo-Login.png"
                                />
                            </CardHeader>
